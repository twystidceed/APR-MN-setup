#!/bin/bash
# TourCoin TOUR Masternode Setup Script V1.0 for Ubuntu 16.04 LTS
#
...
CLI=aprcoin-cli
MONITOR=aprmon.sh
SOURCE='https://github.com/APRCoin/zenith-repository/releases/download/V3.1.0/aprcoin-v3.1.0-linux.zip'
ARCHIVE=aprcoin-v3.1.0-linux.zip
FOLDER2=Ubuntu/
